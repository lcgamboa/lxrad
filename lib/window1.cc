...
{
  mprint (wxT("on timer\n"));
  edit1.SetText (wxT("1_") + edit1.GetText ());
};
...
printf("CJanela1::button1MouseButtonRelease\n");
...
CJanela1::button2MouseButtonRelease (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  if (Dialog (wxT("Voce quer mesmo fazer isso?")))
    {
      Janela2.draw1.SetImgFileName (wxT("teste.png"));
      mprint (wxT("Ok\n"));
    }
  else
    {
  ...
  printf("CJanela1::button2MouseButtonRelease\n");
};
...
CJanela1::button3MouseButtonRelease (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  printf("CJanela1::button3MouseButtonRelease\n");
};
...
CJanela1::pmenuitem2_3MouseButtonPress (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  printf("CJanela1::pmenuitem2_3MouseButtonPress\n");
};
...
CJanela1::pmenuitem1_3MouseButtonPress (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  printf("CJanela1::pmenuitem1_3MouseButtonPress\n ");
};
...
CJanela1::pmenuitem1_2MouseButtonPress (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  printf("CJanela1::pmenuitem1_2MouseButtonPress\n");
};
...
{
  String s;	
  //Message ("Qual é o problema meu ???????????????????????");
  printf ("Qual é o problema meu\n");
...
CJanela1::AjudaMouseButtonPress (CControl * control, uint button, uint x, uint y, uint state)
{
  ...
  printf("CJanela1::AjudaMouseButtonPress\n");
};
...
void
CJanela1::ComboChange (CControl * control)
{
