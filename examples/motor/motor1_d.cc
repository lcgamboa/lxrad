CPWindow1::CPWindow1(void)
{
  ...
  button1.SetText(wxT("Configurar"));
  CreateChild(&button1);
  //button2
  ...
  button3.SetText(wxT("Desconectar"));
  CreateChild(&button3);
  //button4
  ...
  button5.SetText(wxT("m esquerda"));
  CreateChild(&button5);
  //button6
  ...
  button6.SetText(wxT("m direita"));
  CreateChild(&button6);
  //button7
  button7.SetFOwner(this);
  button7.SetClass(wxT("CButton"));
  button7.SetName(wxT("button7"));
  button7.SetTag(0);
  button7.SetX(273);
  button7.SetY(203);
  button7.SetWidth(90);
  ...
  button7.SetText(wxT("m esquerda"));
  CreateChild(&button7);
  //button8
  button8.SetFOwner(this);
  button8.SetClass(wxT("CButton"));
  button8.SetName(wxT("button8"));
  button8.SetTag(0);
  button8.SetX(381);
  button8.SetY(203);
  button8.SetWidth(90);
  ...
  button8.SetText(wxT("m direita"));
  CreateChild(&button8);
  //button9
  button9.SetFOwner(this);
  button9.SetClass(wxT("CButton"));
  button9.SetName(wxT("button9"));
  button9.SetTag(0);
  button9.SetX(328);
  button9.SetY(256);
  ...
  button9.SetText(wxT("posicionar(2)"));
  CreateChild(&button9);
  //button10
  button10.SetFOwner(this);
  button10.SetClass(wxT("CButton"));
  button10.SetName(wxT("button10"));
  button10.SetTag(0);
  button10.SetX(272);
  button10.SetY(315);
  button10.SetWidth(80);
  button10.SetHeight(25);
  button10.SetHint(wxT(""));
  ...
  button10.SetText(wxT("sobe"));
  CreateChild(&button10);
  //button11
  button11.SetFOwner(this);
  button11.SetClass(wxT("CButton"));
  button11.SetName(wxT("button11"));
  button11.SetTag(0);
  button11.SetX(390);
  button11.SetY(314);
  button11.SetWidth(80);
  button11.SetHeight(25);
  button11.SetHint(wxT(""));
